...
ATrainFiles = getFiles('/kaggle/input/011-test/011')
#BTrainFiles = getFiles('/kaggle/input/250mix/mix-train-m')
...
import PIL
path = "/kaggle/input/5-20-minst/256x256/train/1"


    
cycle_gan_model.load_weights('/kaggle/input/model-mix-250/model-mix250')
...
predict_A(path, A_ds, '/kaggle/working/result/train-c/5/')
